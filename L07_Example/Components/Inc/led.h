...
/**
  ...
  * @retval None
  */
void LED_DIO_On(LED_DIO_Handle_TypeDef* hled);
...
/**
  ...
  * @retval None
  */
void LED_DIO_Off(LED_DIO_Handle_TypeDef* hled);
...
/**
  ...
  * @retval None
  */
void LED_DIO_Toggle(LED_DIO_Handle_TypeDef* hled);
...
/**
  ...
  * @retval None
  */
void LED_DIO_Write(LED_DIO_Handle_TypeDef* hled, LED_DIO_State_TypeDef state);
